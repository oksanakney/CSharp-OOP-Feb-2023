...
namespace UniversityCompetition.Core
{
    public class Controller : IController
    {
        ...
        public string AddSubject(string subjectName, string subjectType)
        {
            ...
            // GetType za da ne pravim owe 100 if-a -> reflexion
        }
        ...
        public string AddUniversity(string universityName, string category, int capacity, List<string> requiredSubjects)
        {
            ...
            // imame vsi4kite subjects pravime gi na List<int>
            List<int> requiredSubjectsAsInts = requiredSubjects
                .Select(s => subjects.FindByName(s).Id).ToList();
                //requiredSubjects.Select(s => int.Parse(s)).ToList();

            University university = new University
                (0, universityName, category, capacity, requiredSubjectsAsInts);
        ...
        public string TakeExam(int studentId, int subjectId)
        {
            ...
            { 
                ...
                //ve4e imame studenta zareden -> student.FirstName!!!
            }
        ...
        public string ApplyToUniversity(string studentName, string universityName)
        {
            ...
            return String.Format(OutputMessages.StudentSuccessfullyJoined,student.FirstName,
                student.LastName, universityName);
        } 
